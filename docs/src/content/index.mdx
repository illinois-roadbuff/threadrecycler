...
An efficient thread management module written in Luau for Roblox. (Strictly typed) (Also my first public module)
...
## Limitations
* Must replace `task.wait()` with `ThreadRecycler.wait()` to prevent issues in the task library. (more context on that in the API reference)
...
* In addition to this being my first public module, this is also my first benchmark? 
...
<Table>
  ...
  <tbody>
    {[
      ...
      { workload: 100, method: "Recycled Unsafe Defer", manual: 0.051750, auto: 0.051310, regular: 0.052784 },
      ...
      { workload: 1100, method: "Recycled Unsafe Defer", manual: 0.245513, auto: 0.241942, regular: 0.238632 },
      ...
      { workload: 2100, method: "Recycled Unsafe Defer", manual: 0.253181, auto: 0.225600, regular: 0.428708 },
      ...
      { workload: 3100, method: "Recycled Unsafe Defer", manual: 0.616978, auto: 0.607503, regular: 0.616689 },
...
<Callout type="info">
Benchmark Roblox place is in the GitHub repository. /root/benchmarks
</Callout>
