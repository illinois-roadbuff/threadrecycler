...
### `recycler.wrap(ManualRecycle: boolean, callback: function, ...: any)`
...
```lua copy filename="some-script.lua"
ThreadRecycler.wrap(false, function() -- function(index: number) if use signal == true
    print("Thread executed")
end)
```

### `recycler.spawn(ManualRecycle: boolean, callback: function, ...: any)`
...
### `recycler.defer(ManualRecycle: boolean, callback: function, ...: any)`
...
### `recycler.gooddefer(ManualRecycle: boolean, callback: function, ...: any)`
...
### `recycler.unsafedefer(ManualRecycle: boolean, callback: function, ...: any)`
...
### `recycler.unsafedelay(ManualRecycle: boolean, time: number, callback: function, ...: any)`
...
### `recycler.delay(ManualRecycle: boolean, time: number, callback: function, ...: any)`
Uses `ThreadRecycler.wait()` to execute the function after some time has been elapsed.
```lua copy filename="some-script.lua"
ThreadRecycler.delay(1, false, function()
